This is the convenience zip for EL4J 3.1

A list of known issues can be found at:
https://el4j.svn.sourceforge.net/svnroot/el4j/trunk/el4j/etc/KnownIssues.txt
...
To start with a trivial program (1 class and 1 test)      
      ...
      * execute source ./setupPathsAndEnvironment.sh
      * mvn org.apache.maven.plugins:maven-archetype-plugin:1.0-alpha-7:create -DarchetypeGroupId=ch.elca.el4j.archetypes -DarchetypeArtifactId=EL4JCore -DarchetypeVersion=3.1 -DgroupId=ch.elca.el4j -DartifactId=myFirstProject -DremoteRepositories=http://el4.elca-services.ch/el4j/maven2repository
      * cd myFirstProject
      * mvn install
      * mvn exec:java
 ...
 * if you're outside of ELCA, this will fail due to missing database driver
     ...
     * Download the Oracle driver (ojdbc6_g.jar) from "http://www.oracle.com/technetwork/database/features/jdbc/index-091264.html". 
